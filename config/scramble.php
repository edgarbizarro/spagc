...
return [
    ...
    'ui' => [
         ...
         */
        'logo' => 'https://cdn.freebiesupply.com/logos/large/2x/laravel-logo-svg-vector.svg',
    ...
    'auth' => [
        'bearer' => [
            'type' => 'bearer',
            'name' => 'Authorization',
            'value' => 'Bearer YOUR_ACCESS_TOKEN', // Substitua por um token exemplo
        ],
    ],
